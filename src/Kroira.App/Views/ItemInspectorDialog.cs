...
namespace Kroira.App.Views
{
    public sealed class ItemInspectorDialog : ContentDialog
    {
            ...
            IExternalPlayerLaunchService externalPlayerLaunchService)
        {
            ...
            PrimaryButtonText = "Copy Safe Report";
            SecondaryButtonText = snapshot.SupportsExternalLaunch ? "Open External" : string.Empty;
        ...
        private void CopySafeReport_Click(ContentDialog sender, ContentDialogButtonClickEventArgs args)
        {
            ...
            try
            {
                ...
                Clipboard.Flush();
                _actionStatusText.Text = "Copied a share-safe inspection report to the clipboard.";
            }
            catch (Exception ex)
            {
                _actionStatusText.Text = $"Copy failed. {ex.Message}";
            }
        }
