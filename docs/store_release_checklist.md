...
- **Required Capabilities in Manifest**:
  ...
  - `backgroundMediaPlayback` (For maintaining audio/state during brief minimizations).
...
- **Asset Scrubbing**: All Store screenshots must use mock/sample metadata (e.g., Big Buck Bunny artwork) to pass Microsoft copyright AI checks. Real channel logos are forbidden in marketing.
- **Naming**: Ensure "KROIRA - Modern IPTV Player" is used to avoid deceptive app categorization.
